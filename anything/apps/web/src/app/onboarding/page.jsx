        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {OPTIONS.map((opt, i) => (
            <motion.button
              ...
              disabled={loading}
              className="flex items-center gap-6 rounded-[32px] border border-zinc-800 bg-zinc-900 p-8 text-left transition-all hover:border-zinc-700 hover:bg-zinc-800 active:scale-95 disabled:opacity-50"
            >
              <div
